        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_projects_status", "status IN ('Active', 'Paused', 'Completed', 'Cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_project_members_role", "role IN ('Owner', 'Member')");
                    table.ForeignKey(
